...
![Endpoint Telemetry Proof](images/real%20security%20data%20(index=main%20showing%20EventCode%204672)%20split%20screen.png)
...
![Kali Attack Simulation](images/Kali%20ifconfig%20&%20Python%20Honeypot%20server.png)
...
![Splunk Threat Detection](images/final%20result-attack%20and%20detect%20split%20screen.png)
...
![Splunk Dashboard](images/Splunk%20Pie%20Chart%20Dashboard.png)

![Triggered Splunk Alert](images/Splunk%20Triggered%20Alerts%20flashing%20High%20Severity.png)
...
![Firewall Rule](images/a%20custom%20Inbound%20TCP%20rule%20for%20port%209997.png)
...
![Event Viewer Check](images/event%20viewer-%20sysmon%20operational%20logs.png)
...
![Service Validation](images/services_check.png)
